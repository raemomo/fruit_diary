 ...
 * @since 5.2.0
 */
export type AddDocumentSnapshotListenerCallback<T> = (event: AddDocumentSnapshotListenerCallbackEvent<T> | null, error: any) => void;
/**
 * @since 5.2.0
 */
 ...
 * @since 5.2.0
 */
export type AddCollectionSnapshotListenerCallback<T> = (event: AddCollectionSnapshotListenerCallbackEvent<T> | null, error: any) => void;
/**
 * @since 5.2.0
 */
 ...
 * @since 6.1.0
 */
export type AddCollectionGroupSnapshotListenerCallback<T> = (event: AddCollectionGroupSnapshotListenerCallbackEvent<T> | null, error: any) => void;
/**
 * @since 6.1.0
 */
